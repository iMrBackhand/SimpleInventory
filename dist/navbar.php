            ...
            <ul class="d-none d-md-inline-block form-inline ms-auto me-0 me-md-3 my-2 my-md-0">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="accounts-details.php?dashboard&id=<?= $userdetails['id']; ?>">My Profile</a></li>
                        <li><a class="dropdown-item" href="settings-password.php?dashboard&id=<?= $userdetails['id']; ?>">Settings</a></li>
                        <li><hr class="dropdown-divider" /></li>
                        <li><a class="dropdown-item" href="controller/controller-logout.php">Logout</a></li>
                    </ul>
                </li>
            </ul>
        </nav>
            ...
            <div id="layoutSidenav_nav">
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseExpenses" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="expenses-table.php">Expenses</a>
                                </nav>
                            </div>
                            ...
                            <a class="nav-link" href="categories-table.php">
                                <div class="sb-nav-link-icon"><i class="fas fa-list"></i></div>
                                Categories
                            </a>
                            <a class="nav-link" href="items-table.php">
                    ...
                    <div class="sb-sidenav-footer">
                        ...
                        <a href="accounts-details.php?dashboard&id=<?= $userdetails['id']; ?>"><?= $userdetails['name']; ?></a>
                    </div>
                </nav>
            </div>
