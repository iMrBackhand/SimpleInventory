...
<html lang="en">
    <head>
        ...
        <title>Create Category - IMS</title>
                            ...
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <?php if (isset($_GET['category-added'])) { ?>
                                            <div class="text-center text-success mb-2">
                                                Category successfully added.
                                            </div>
                                        <?php } elseif (isset($_GET['category-exists'])) { ?>
                                        ...
                                        <form action="" method="post">
                                            ...
                                            <div class="form-floating mb-3">
                                                <textarea class="form-control" id="exampleFormControlTextarea1" placeholder="Description" rows="5" name="description"></textarea>
                                                <label for="exampleFormControlTextarea1" class="form-label">Description</label>
                                            </div>
                                            
                                            <div class="mt-4 mb-0">
                                                <div class="d-grid"><button type="submit" class="btn btn-primary btn-block" name="create-category">Create Category</button></div>
                                            </div>
                                        </form>
                                    </div>
                                    <div class="card-footer text-center py-3">
                                        <div class="small"><a href="categories-table.php"> Go to Categories.</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
